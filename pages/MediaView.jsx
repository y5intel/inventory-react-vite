            ...
            <div className="bg-[#FFF] h-[354px] rounded-[32px] ml-[10px] mr-[13px] flex flex-col relative">
              ...
              <div
                className={`flex flex-col pt-[22px] ${
                  !sidebarActive ? "mx-[30px]" : "mx-[18.3px] mr-[37.7px]"
                }`}
              >
                ...
                <div className="mx-auto text-[#FF0202] text-[11px] font-normal leading-[16.123px] tracking-[0.88px]">
                ...
                <div className="ml-auto flex flex-row gap-2 pt-6">
