        ...
        {!isComplete ? (
          ...
          >
            ...
            <div className="flex justify-between mx-[24px] mt-[20px]">
              ...
              <button
                className="rounded-[25px] w-[155px] h-[50px] bg-[#4FC38E] px-auto py-auto gap-[10px] text-black text-xs leading-[14.883px] tracking-[0.66px]"
                onClick={() => setShowModal(true)}
              >
                Recycle Offer
              </button>
              <button
                className="rounded-[25px] w-[110px] h-[50px] bg-[#FFA74B] px-auto py-auto gap-[10px] text-black text-xs leading-[14.883px] tracking-[0.66px]"
