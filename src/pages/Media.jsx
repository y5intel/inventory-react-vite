  ...
  return (
    <>
      <div className="bg-[#D9D9D9] w-full h-[428px]">
        ...
        <div className="bg-[#FFF] h-[278px] rounded-[32px] ml-[10px] mr-[13px] flex flex-col">
          ...
          <div className="mr-[10px] mb-[20px] pl-[29px] pr-[14px] pb-[5px] grid grid-cols-3 gap-[10px] mt-[11px] overflow-y-auto">
            <Link to="/media/view">
